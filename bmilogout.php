...
<html>
    ...
    <TD><DIV ALIGN=CENTER>Your Age</DIV></TD> 
    ...
    <TD><INPUT TYPE=TEXT NAME=height  SIZE=10 onFocus="this.form.height.value=''"></TD>
     <TD><INPUT TYPE=TEXT NAME=age  SIZE=10 onFocus="this.form.age.value=''"></TD>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col l4 offset-l2 s12">
						...
						<ul>
							<li><p class="grey-text text-lighten-3"> Mobile No: 9876540321</p></li>
